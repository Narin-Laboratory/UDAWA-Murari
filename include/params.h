...
#define CURRENT_FIRMWARE_TITLE "Murari"
...
#define ENVIRO_SENSOR_STACKSIZE 8192UL
...
static constexpr char model[] PROGMEM = "Murari";
static constexpr char hname[] PROGMEM = "murari";
static constexpr char group[] PROGMEM = "Murari";
...
const unsigned long enviroSensorAlarmTimer = 30; //in second
